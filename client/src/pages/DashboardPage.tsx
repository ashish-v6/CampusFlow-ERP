      ...
      <header className="w-full h-16 shrink-0 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-400">
            <Link to="/dashboard" className="flex items-center gap-2 text-white bg-slate-900 border border-slate-800 px-3 py-1.5 rounded-lg">
              <LayoutDashboard className="w-4 h-4 text-blue-400" />
              <span>Overview</span>
            </Link>
            <a href="#students" className="flex items-center gap-2 hover:text-white transition-colors duration-200">
              <Users className="w-4 h-4" />
              <span>Students</span>
            </a>
            <a href="#analytics" className="flex items-center gap-2 hover:text-white transition-colors duration-200">
              <BarChart3 className="w-4 h-4" />
              <span>Analytics</span>
            </a>
            <a href="#settings" className="flex items-center gap-2 hover:text-white transition-colors duration-200">
        ...
        <div className="bg-gradient-to-r from-blue-950/60 via-slate-900/90 to-slate-900/80 border border-slate-800 rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-xl">
          <div className="relative z-10 space-y-2 max-w-2xl">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Here is what is happening across your campus today. Manage student records, administrative workflows, and academic operations seamlessly.
            </p>
          </div>
        </div>
