...
export default function DashboardPage(): React.JSX.Element {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground relative transition-colors duration-200">
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-primary/10 rounded-full blur-[160px] pointer-events-none z-0" />
      ...
      <header className="w-full h-16 shrink-0 border-b border-border/80 bg-background/80 backdrop-blur-md sticky top-0 z-50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
            <Link
              to="/dashboard"
              className="flex items-center gap-2 text-foreground bg-card border border-border px-3 py-1.5 rounded-lg"
            >
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center relative">
              ...
              <input
                ...
                className="bg-card border border-border rounded-xl pl-9 pr-3 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 w-44 lg:w-56"
              />
            </div>

            <button
              type="button"
              className="p-2 text-muted-foreground hover:text-foreground bg-accent/50 border border-border hover:border-muted-foreground rounded-xl transition-all relative"
            ...
            <button
              ...
              className="flex items-center gap-2 text-xs font-medium text-muted-foreground border border-border hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-500 bg-accent/50 px-3 py-1.5 rounded-xl transition-all duration-200 cursor-pointer"
            >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 z-10 space-y-6">
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-primary/10 via-card to-card border border-border rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="bg-card border border-border rounded-2xl p-5 space-y-3 shadow-sm">
            ...
            <div>
              ...
              <span className="text-xs text-emerald-500 font-medium">+4.2% from last semester</span>
            </div>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-5 space-y-3 shadow-sm">
            ...
            <div>
              ...
              <span className="text-xs text-emerald-500 font-medium">98.5% completion rate</span>
            </div>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-5 space-y-3 shadow-sm">
            ...
            <div>
              ...
              <span className="text-xs text-muted-foreground font-medium">Across 18 departments</span>
            </div>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-5 space-y-3 shadow-sm">
            ...
            <div>
              ...
              <span className="text-xs text-emerald-500 font-medium">All services operational</span>
            </div>
          </div>
        </div>
      </main>
