...
/**
 * Header component for the Department Details page.
 * Includes back navigation and role-aware edit action.
 */
export default function DepartmentDetailsHeader({
  onEdit,
  canEdit = false,
  backUrl = "/departments",
  backText = "Back to Departments",
}: DepartmentDetailsHeaderProps): React.JSX.Element {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm sm:text-base mt-1">
            View department overview, institutional code, and operational status.
          </p>
        </div>
