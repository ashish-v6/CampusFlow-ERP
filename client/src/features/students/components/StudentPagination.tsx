...
import { StudentPaginationMeta } from "../types/student.types";

interface StudentPaginationProps {
  paginationDetails: StudentPaginationMeta;
  currentPage: number;
  setCurrentPage: (page: number) => void;
}

/**
 * Pagination component for Student directory.
 * Preserves exact layout, styling, and windowed pagination math from UserPagination.
 */
export default function StudentPagination({
  paginationDetails,
  currentPage,
  setCurrentPage,
}: StudentPaginationProps): React.JSX.Element {
